<template>
  <el-row :gutter="40" class="panel-group">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('2dmap')">
        <div class="card-panel-icon-wrapper icon-message">
          <svg-icon icon-class="2dmap" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">二维地图</div>
          <count-to :start-val="0" :end-val="7" :duration="3000" class="card-panel-num"/>
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('3dmap')">
        <div class="card-panel-icon-wrapper icon-money">
          <svg-icon icon-class="3dmap" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">三维模型</div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('table')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">table</div>
