(function () {
    ...
    callWithJQuery(function ($) {
      ...
      if (plotly) {
        $.pivotUtilities.locales.zh.plotly_renderers = {
          "水平柱形图": plotly["Horizontal Bar Chart"],
          "水平堆积柱形图": plotly["Horizontal Stacked Bar Chart"],
          "折线图": plotly["Line Chart"],
          "柱形图": plotly["Bar Chart"],
          "堆栈柱形图": plotly["Stacked Bar Chart"],
          "面积图": plotly["Area Chart"],
          "散点图": plotly["Scatter Chart"],
          "多饼图": plotly["Multiple Pie Chart"],
        };
        $.pivotUtilities.locales.zh.renderers = $.extend($.pivotUtilities.locales.zh.renderers, $.pivotUtilities.locales.zh.plotly_renderers);
      }
